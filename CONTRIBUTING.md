...
Thank you for your interest in `loopback-android-getting-started`, an open source project
administered by StrongLoop.

Contributing to `loopback-android-getting-started` is easy. In a few simple steps:
